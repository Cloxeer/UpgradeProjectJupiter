...
- Round 2 (Sept. 8, later): Carbon diagram constants fixed (8.82 Mt permitted, 10.1 applied for; residual carries the penalty uplift; 176 Mt over 20 years). Blueprint "their plan" mode now shows THEIR filed plan (`theirsCards` in blueprintVoices.ts: their titles, "As filed" takeaways, chips/voices hidden, hero line and sliders follow the switch). Water gauge: theirs line no longer reaches the floor; captions "basin decline continued · not this campus alone", never "wells dry"; ours = "slower, not reversed" with gallons made and recharged drawn as bars; row label "taken, or added". Heat/greenhouse: no summer cooling counted (pads and vents), "up to 60M lbs", HEAT_MW = 2,462. Year 250 removed; year 80 is the last, labelled estimate. Petition = a count of support, not a legal instrument; what binds is a written comment on the Permit 10883 record and the commission microphone (step 3 order: comment, show up, call, then sign).

- Round 3 (Sept. 8, later): "As filed" takeaways are per reader (`theirsCards[kicker].takeaway[audience]`, plain words for Earth/homeowner/legislator/business, the technical sentence only for expert). Water card states realism: NMSU plant designed, CBA pays a $250,000 study, county STAR plant under way, condition funds the full system, opens ~2031, no surplus, recharge from year 5 after a State Engineer permit. Every process card carries its year (capture metered from year 5, plant year 5, greenhouses first block year 5 and full by year 10, wind needs new transmission).
