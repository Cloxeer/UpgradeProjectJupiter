  ...
  return (
    <footer style={{ backgroundColor: "#003047" }}>
      <div className="pj-container py-6 text-center">
        ...
        <div className="mt-5">
          <a href="/original/" className="pj-press inline-flex min-h-[48px] items-center rounded-full px-6 text-[15px] font-black uppercase tracking-wide" style={{ backgroundColor: "#fdb715", color: "#003047" }}>
            Click to see the old original site
          </a>
          <p className="mt-2" style={{ fontSize: 13, color: "rgba(255,255,255,0.55)" }}>The version of this site before it became a story.</p>
        </div>
        <p className="mt-5" style={{ fontSize: 13, lineHeight: 1.5, color: "rgba(255,255,255,0.6)" }}>About this site: independent commentary and a policy proposal by a student. Statements about Project Jupiter are drawn from the developers&apos; own publications, the signed county agreement, state permit filings and named news reports, each linked on the Sources page; our figures are estimates where marked. No statement here should be read as an accusation of wrongdoing by any person or company. Corrections are welcome and will be posted.</p>
