  ...
  return (
    <footer style={{ backgroundColor: "#003047" }}>
      <div className="pj-container py-6 text-center">
        ...
        <p className="mt-3">
          <a href="/original/" className="inline-flex min-h-[44px] items-center text-[14px] font-bold underline" style={{ color: "#ffffff" }}>
            View the original version of this site
          </a>
          <span className="ml-1 align-middle" style={{ fontSize: 13, color: "rgba(255,255,255,0.55)" }}>(before the redesign)</span>
        </p>
