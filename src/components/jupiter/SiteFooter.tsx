  ...
  return (
    <footer style={{ backgroundColor: "#003047" }}>
      <div className="pj-container py-6 text-center">
        ...
        <p className="mt-3" style={{ fontSize: 13, color: "rgba(255,255,255,0.55)" }}>
          <a href="/original/" className="inline-flex min-h-[36px] items-center underline" style={{ color: "rgba(255,255,255,0.7)" }}>See the old original site</a>
          {" "}(this site before it became a story)
        </p>
