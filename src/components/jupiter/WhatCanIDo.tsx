...
const G = "#2e8b57";
const SHARE_TEXT = "Do not cancel Project Jupiter. Force the upgrade: catch the carbon, reuse the heat, make water, hire here. Same land, same buildings, about 8% more on the $50 billion first phase, most of it repayable by the federal capture credit.";
