...
export const topics: Topic[] = [
  {
    ...
    fix: "Tie the bond benefit to jobs verified each year and fund a training institute on site: about 3,000 jobs and about $1 billion over 30 years, for about 2.5% of the bond cap before the federal capture credit.",
    ...
    expert: [
      ...
      { line: "Added capital ≈ $3.4–3.9B (capture $1.5B; CO₂ transport, wells and storage care $1.5–2B; desal $0.27B; HX $0.06B; solar $0.045B; institute $0.05B) ≈ 2.5% of the $165B bond cap ≈ 8% of the $50B five-year commitment, plus +$640M PILT over 30 years; growers add ≈$0.47B. 45Q at $85/t × ~7.9 Mt/yr × 12 yr ≈ $8B if construction starts before 2033.", sources: ["cba", "irs-45q"] },
  ...
  },
  {
    ...
    expert: [
      ...
      { line: "Summer: single-effect LiBr absorption chillers want ≈90 °C and reject ≈2.4× their cooling as heat; this loop is 45–65 °C, so absorption cooling is not counted. Summer cooling is evaporative pads (≈3–15 L/m²/day in Arizona → ≈1–1.6 MGD for 150 acres, consumptive). Desal preheat runs year-round.", sources: ["absorption-review"] },
    ],
  ...
  },
  {
    ...
    expert: [
      { line: "≈150 acres (proposal); 4–6.5 jobs/acre incl. packing (Marfa 4.9, Willcox 5.7); up to ≈400,000 lb/acre/yr (top-tier tomato; mixed crop 200–300k); ≈90% less water per lb than field farming; CO₂ uptake per acre unverified (estimate). Summer pad cooling ≈1–1.6 MGD for 150 acres. No Santa Teresa study.", sources: ["agriport"] },
