...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    expert: [
      ...
      { line: "Recharge: CRRUA's Sunland Park (2.1 MGD capacity, <1 MGD flow) and North (1 MGD, ~0.8) plants ≈1.8 MGD of wastewater today; treated to drinking standard → infiltration basins, plus plant surplus while output > demand: 2–5 MGD back into the fresh aquifer vs 3.1 MGD CRRUA pumped in 2020. Permit: Ground Water Storage and Recovery Act (72-5A NMSA, 19.25.8 NMAC); NM's first (Bear Canyon, ABQ) took 2008 tests → 2014 permit. Precedent: El Paso since 1985, up to 3 MGD, >30 billion gal, Hueco levels stabilized. NMSU flags return-flow water-rights accounting near the river.", sources: ["nmsu", "nm-asr-act", "abcwua-bear-canyon", "epwater-recharge", "epwater-aquifers"] },
      { line: "Brine minerals, order of magnitude: ~2,000 mg/L TDS × 5 MGD ≈ 38 t/day ≈ 14,000 t/yr of dissolved salts (mostly Na, Cl, SO₄; Ca 20–84, Mg 4–24 mg/L). Even at $500/t for every ton ≈ $7M/yr ≈ the plant's own O&M at NMSU's $4 per 1,000 gal. Brine ≈ 5,000–14,000 mg/L vs seawater 35,000: inland brine is dilute, which is why GAO finds brine mining unproven at scale and the 2024 MRED brackish pilot treats Mg(OH)₂ as a byproduct of higher water recovery. Water is the product; salts are a bonus.", sources: ["nmsu", "gao-brine-minerals", "mred-brackish", "ewm-elpaso"] },
