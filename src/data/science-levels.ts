...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    icon: "🔥",
    title: "Heat",
    problem: "About 2,462 MW of warmth, roughly 90,000 home furnaces' worth, is blown into the desert by fans.",
    ...
    expert: [
      { line: "IT load 2,462 MW → reject heat ≈ 2,462 MW (thermodynamic identity, not measured). 1 MW ≈ 38 × 90,000 BTU/hr furnaces.", sources: ["notice", "carrier-furnace"] },
