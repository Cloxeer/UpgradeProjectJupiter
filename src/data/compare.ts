...
export const compareRows: CompareRow[] = [
  {
    ...
    why: "The state's draft permit puts the fuel-cell plant at 10,144,115 tons of CO₂ a year, more than Albuquerque and Las Cruces combined. Dried, that exhaust is about 95% CO₂, which is the easy case for capture. Bloom already partners with Chart Industries to sell it. We ask that it run from the first day.",
    ...
    voices: {
      legislator: "NMED draft permit 10883 lists 10,144,115 tons CO₂e a year. The anode exhaust is about 95% CO₂ once dried, so capture is a standard skid, not a research project. The lease can require it before power-on; the permit is already stayed and will be reissued anyway.",
  ...
  },
  {
    ...
    why: "More than 103 million gallons were pumped from the fresh aquifer for construction in five months before a court stopped it, and the signed agreement lets the campus draw up to 20,000 gallons a day of drinking water from the local utility. NMSU designed a plant in 2023 that turns deep salty water into 5 million gallons a day of clean water. We ask that it be built and handed to the towns.",
    ...
    voices: {
      homeowner: "This is your tap. CRRUA needs 6 million gallons a day next year and 15 by 2042. The plant makes 5 million a day from water nobody could drink, so your supply goes up instead of down.",
      business: "A designed, priced plant with a utility customer whose demand more than doubles by 2042. El Paso has run a 27.5 MGD brackish plant since 2007. Water is a product here.",
    },
  ...
  },
  {
    ...
    label: "Smog rules",
    kidLabel: "Smog check",
    theirs: { num: "Split", tail: "each piece under the strict line" },
    ours: { num: "One permit", tail: "every stack on a public meter" },
    why: "The filed permit keeps each smog pollutant just under 250 tons a year, the line that would trigger the strict federal review, over a valley that has failed the ozone standard since 2018. We ask for one permit for the whole campus, with continuous monitors on every stack and the readings published.",
    kidWhy: "The air here already fails the safe-breathing test. We want every bit of smog measured and shown to everyone on a screen.",
    voices: {
      homeowner: "On hot days the exhaust helps make ozone over Sunland Park and Santa Teresa. Monitors on every stack with public readings mean you can see the air the day it happens.",
    },
