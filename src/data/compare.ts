...
export type CompareRow = {
  ...
  /** what kind of claim each number is (fact, verified estimate, projection, unknown) */
  theirsLabel: ClaimLabel;
  oursLabel: ClaimLabel;
...
export const compareRows: CompareRow[] = [
  ...
  },
  {
    ...
    sources: ["cbd-well", "haussamen-water", "cba", "nmsu", "epwater", "star-plant", "epwater-brine-recovery", "epwater-recharge", "nm-asr-act", "rio-rancho-pure", "nmsa-72-12-8"],
  },
  {
    id: "food",
    label: "Heat and food",
  ...
  },
  {
    ...
    ours: { num: "~8%", tail: "of the $50B first phase (2.5% of the bond cap, a ceiling, not cash)" },
    theirsLabel: "fact",
    oursLabel: "projection",
    why: "Capture, its pipeline and wells, the heat exchanger, the water plant, solar and the institute add about $3.4 to 3.9 billion of capital, plus $640 million more in payments over 30 years, to a project whose companies committed $50 billion for the first five years under a $165 billion bond cap: about 8% of that first phase, or 2.5% of the cap, which is a ceiling rather than cash. Growers add about $470 million of their own. The federal 45Q credit, $85 a ton captured for 12 years, could repay most of the capture cost. Same buildings, same fence; the pipeline and permits add years to the storage side, not to the halls.",
    ...
    voices: {
      business: "About 8% of Phase 1 capital (2.5% of the bond cap), with 45Q at $85 a ton covering most of the capture line, plus leases and water sales, for a permit that stays out of court. The greenhouses are off your balance sheet.",
    },
