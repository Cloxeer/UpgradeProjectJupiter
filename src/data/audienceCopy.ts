...
const legislator: Copy = {
  ...
  willList: [
    ...
    "Capture-ready stacks from day one, capture metered once the storage line is connected (about year 5), continuous monitoring on every cluster, and a geothermal and delivered-renewables schedule that gives HB93's 2045 date a physical path",
  ],
  ...
  willNotList: [
    ...
    "About 2,462 MW of usable heat blown into the desert while the county designs a water plant with its own Jupiter tax money",
  ],
...
const business: Copy = {
  ...
  willList: [
    ...
    "Winter greenhouse heat and year-round desalination preheat from about 2,462 MW that is rejected for free today",
  ...
  willNotList: [
    "About 2,462 MW of heat rejected with no buyer",
...
const kid: Copy = {
  ...
  pitches: [
    { title: "If you are 6 now: when you are 12 (year 6)", body: "The plant has run four years. As filed: smoggy afternoons, and the water table under your town a little lower. Upgraded: the water plant and the gas-catching line came on last year, the first greenhouses are growing, and the town's cleaned water has started going back into the ground." },
    { title: "When you are 18 (year 12)", body: "As filed: 750 jobs were promised, the air permit allows the same smog every year, and nothing has been added to the water. Upgraded: about 3,000 jobs, a training school on site, clean water for 16,700 homes every day for seven years, the gas catcher at its target, and the gas machines resting more each year." },
    { title: "When you are 30 (year 24)", body: "As filed: 24 years of the same. Upgraded: the gas machines rest more every year as hot rock and wind take over, the site has been feeding, watering and hiring your town for most of your life, and some of the concrete around you has the plant's own gas locked inside it." },
  ],
