            ...
            <div className="mx-auto mt-10 max-w-[820px]">
              <details className="rounded bg-white p-5 shadow-sm sm:p-6" open>
                ...
                <div className="mt-3" style={{ fontSize: 17, lineHeight: 1.65, color: "#3c3c3c" }}>
                  ...
                  <p className="mt-5">
                    Same land. Same buildings. About 8% more on the $50 billion first phase, most of it repayable by the federal capture credit. Clean air, new water, local food, and about 3,000 permanent jobs instead of the
